...
public class Covariance extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    conf.set("yarn.app.mapreduce.am.command-opts", "-Xmx4000m");
    conf.set("yarn.app.mapreduce.am.resource.mb", "5000");
    conf.set("yarn.nodemanager.resource.memory-mb", "5000");
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new Covariance(), args);
    System.exit(res);
  }
